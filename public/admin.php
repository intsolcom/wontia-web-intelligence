...
<aside class="w-sidebar" id="sidebar">
    ...
    <nav class="w-sidebar-nav">
        ...
        <a href="#factory" class="w-nav-item" data-panel="factory">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M2 20a2 2 0 002 2h16a2 2 0 002-2V8l-7 5V8l-7 5V4a2 2 0 00-2-2H4a2 2 0 00-2 2z"/></svg>
            Factory
        </a>
        <?php if (($user['role'] ?? '') === 'client'): ?>
        <a href="#portal" class="w-nav-item" data-panel="portal">
        ...
        <a href="#seo-global-launch" class="w-nav-item" data-panel="seo-global-launch">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M16 8l-8 8"/><path d="M8 8l8 8"/><path d="M12 2v2M12 20v2M2 12h2M20 12h2"/></svg>
            SEO Global Launch
        </a>
