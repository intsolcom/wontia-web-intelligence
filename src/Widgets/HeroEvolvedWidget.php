...
class HeroEvolvedWidget extends Widget
{
    public static function meta(): array { return ['id' => 'hero-evolved', 'name' => 'Hero: AI to Action', 'icon' => 'zap', 'category' => 'header', 'version' => '2.0.0']; }

    public static function configSchema(): array
    {
        return [
            ['key' => 'eyebrow', 'label' => 'Eyebrow', 'type' => 'text', 'default' => 'TECHNOLOGY OF APPLIED INTELLIGENCE'],
            ['key' => 'headline', 'label' => 'Headline', 'type' => 'html', 'default' => 'Turn AI into <span class="gradient-text">Action</span>'],
            ['key' => 'subtitle', 'label' => 'Subtitle', 'type' => 'textarea', 'default' => 'Wontia is an Applied Intelligence Platform that enables TIA to understand context, make intelligent decisions, and execute actions across the systems and domains where work happens.'],
            ['key' => 'cta_primary_text', 'label' => 'Primary CTA', 'type' => 'text', 'default' => 'Explore Wontia Business'],
            ['key' => 'cta_primary_url', 'label' => 'Primary CTA URL', 'type' => 'text', 'default' => '#business'],
            ['key' => 'cta_secondary_text', 'label' => 'Secondary CTA', 'type' => 'text', 'default' => 'Discover TIA'],
    ...
    {
        return '<div style="background:linear-gradient(135deg,#1A1A1E,#2D2240);border-radius:12px;padding:24px;text-align:center"><div style="font-size:11px;color:#B89EFF;letter-spacing:0.1em;margin-bottom:8px">TECHNOLOGY OF APPLIED INTELLIGENCE</div><div style="font-size:22px;font-weight:800;color:#fff">Turn AI into <span style="color:#B89EFF">Action</span></div><div style="font-size:11px;color:#8b8fa3;margin-top:8px">New positioning hero</div></div>';
    }
...
<section style="padding:200px 40px 120px;max-width:1100px;margin:0 auto;text-align:center;position:relative;overflow:hidden">
  <div style="position:absolute;top:-80px;left:50%;transform:translateX(-50%);width:900px;height:500px;pointer-events:none;z-index:0;opacity:0.3">
    <svg viewBox="0 0 900 500" fill="none">
      <defs><radialGradient id="hg2" cx="50%" cy="50%"><stop offset="0%" stop-color="#DCCFFF" stop-opacity="0.5"/><stop offset="100%" stop-color="transparent"/></radialGradient></defs>
      <circle cx="450" cy="250" r="200" fill="url(#hg2)"/>
